...
/**
 * Product:     Layered Navigation Pro for Magento - 15/02/12
 * Package:     AdjustWare_Nav_2.3.3_0.1.4_8_212846
 * Purchase ID: n/a
 * Generated:   2012-02-21 17:08:33
...
{
    var pholder = $('adjnav-page-autoload-pholder');
...
{
    var pholder = Element.select(container, '#adjnav-page-autoload-pholder');
    if (!pholder.size())
    {
        $('adjnav-page-autoload-pholder').remove();
    }
}
